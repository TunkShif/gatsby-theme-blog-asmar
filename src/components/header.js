...
const Header = () => {
  ...
  return (
    <div>
      <div className="flex items-center pb-2">
        ...
        <div className="flex items-center justify-between w-full pl-3">
          <div className="flex flex-col justify-between">
            <h1 className="text-2xl font-bold text-yellow-900">{data.site.siteMetadata.title}</h1>
      ...
      <nav className="flex justify-around py-2 text-lg font-bold border-t-2 border-gray-200">
